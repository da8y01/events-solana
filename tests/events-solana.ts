...
describe("events-solana", () => {
  ...
  it("Bob Should get 48 event tokens", async () => {
    ...
    const bobAccount = await getAccount(provider.connection, bobEventMintATA);
  ...
  it("Bob buy 154 tickets", async () => {
    ...
    // show event gain vault info
    const gainVaultAccount = await getAccount(provider.connection, gainVault);
  ...
  it("Event organizer should withdraw 1 from treasury", async () => {
    ...
    console.log(
      "Event treasury vault total before: ",
      treasuryVaultAccount.amount
    );
    ...
    console.log(
      "Event treasury vault total after: ",
      treasuryVaultAccount.amount
    );
